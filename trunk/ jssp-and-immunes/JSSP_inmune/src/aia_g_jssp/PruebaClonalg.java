...
//Inicializa valores de la poblacion
long start = System.nanoTime();
long end=0;
long tiempo=0;
        // Parametros algoritmo clonalg
    double factor_clonac = 0.3;
        int poblacion = 100;
        int rand_num = 2;
        int num_gen = 10;
...
//        System.out.println("Generar poblacion  "+ tiempo);
...
//************************************************************************************************         
        for (int i = 0; i < poblacion; i++) {
                ...
                System.out.println("poblacion "+ i+" "+M_span_sort[i]);
        }      
//************************************************************************************************    
...
//        end = System.nanoTime();   
//        tiempo = ((end - start) / 1000000);
//        System.out.println("Evaluar poblacion poblacion  "+ tiempo);
//        start = System.nanoTime();
...
//              ****************** CLONACIÓN E HIPERMUTACIÓN ************************   
 ...
 //************************************************************************************************ 
                //Verifica cuantos hijos superan al padre.
                int counter=0;
                int cc=0;
                int totalcount=0;
                for (int i = 0; i < pt_clones; i++) {
                	//System.out.println("poblacion de clones "+ i +" "+Make_span_clon[i]);
                	cc++;
                	if(cc < nclones ){
                		if(Make_span_clon[i] < M_span_sort[totalcount]){
                			counter++;
                		}
                	}else{
...
//                end = System.nanoTime();   
//                tiempo = ((end - start) / 1000000);
//                System.out.println("Clonacion e hipermutacion  "+ tiempo);
//                start = System.nanoTime();

//              ****************** EVALUAR CLONES ****************************
// MAKESPAN POBLACION CLONADA                
...
//                end = System.nanoTime();   
//                tiempo = ((end - start) / 1000000);
//                System.out.println("Evaluar clonacion "+ tiempo);
//                start = System.nanoTime();
...
//        System.out.println( "  " +M_span_sort[0]);
