...
public int[][] Leer_instancia(){
      ...
      //FileInputStream fstream = new FileInputStream("D:\\Datos\\Dropbox\\Implementación de un algoritmo inmune artificial aplicado en el  área  de planificación de recursos\\Software encontrado\\Instancias de Job shop scheduling\\la01.txt");
    	FileInputStream fstream = new FileInputStream("C:\\Documents and Settings\\Invitado\\Mis documentos\\Instancia\\la01.txt");  
