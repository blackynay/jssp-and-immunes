...
public class PruebaClonalg{
        public static void main (String[] args)
        {
                ...
                Clonalg algclon=new Clonalg();
                                ...
                                int[] trabajos={3,8,6,9,4,1,5,7,3,4,2,0,6,8,5,1,9,2,7,0,3,4,1,7,8,6,5,9,2,0,7,1,3,9,8,6,5,4,0,2,1,8,3,7,6,9,5,4,2,0};// instancias la01-la05
                                //int[] trabajos={3,10,13,8,14,6,9,11,4,1,13,5,10,7,3,4,12,2,0,13,6,11,8,5,1,9,2,10,7,0,14,12,3,4,1,13,11,7,8,6,14,5,12,9,2,0,10,7,1,3,11,9,12,8,13,6,5,14,4,0,2,1,8,3,11,10,7,12,6,9,5,4,14,2,0};
                                // instancias la05-la010		
                                //int []trabajos={2,2,4,1,4,5,0,3,2,0,3,5,5,5,0,4,2,4,3,0,3,1,1,1};
                                ...
                                //int[][]instancia={{0,2,1,2,2,2,3,2},{3,2,2,2,1,2,0,2},{1,2,0,2,3,2,2,2},{2,2,3,2,0,2,1,2},{0,2,1,2,2,4,3,1},{3,3,1,3,0,1,2,1}};
